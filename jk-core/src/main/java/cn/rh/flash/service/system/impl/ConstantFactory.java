...
import cn.rh.flash.utils.cache.TimeCacheMap;
...
public class ConstantFactory implements IConstantFactory {
    ...
    @Override
    public Map<String,String> getDictsToMap(String pname) {
        List<Dict> dicts = getDicts(pname);
        if (CollUtil.isEmpty(dicts)){
            return null;
        }
       return dicts.stream().collect(Collectors.toMap(Dict::getNum,Dict::getName));
    }
