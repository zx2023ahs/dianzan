...
public class Menu extends BaseEntity {
    @Column(columnDefinition = "VARCHAR(100) COMMENT '编号'", unique = true, nullable = false)
    @NotBlank(message = "编号不能为空")
    private String code;
    @Column(columnDefinition = "VARCHAR(100) COMMENT '父菜单编号'", nullable = false)
     ...
     */
    @Column(columnDefinition = "VARCHAR(200) COMMENT '资源/权限标识'")
    private String url;
    ...
    @Column(columnDefinition = "INT COMMENT '状态1:启用,0:禁用'" )
