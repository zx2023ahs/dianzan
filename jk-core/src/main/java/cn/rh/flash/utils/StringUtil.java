...
public class StringUtil {
    ...
    * @param template 文本模板，被替换的部分用 {key} 表示
    ...
    public static String addXing(String account){
        if (account != null) {
            String s = sub( account, 0, 4 );
            String e = sub( account, account.length() - 4,  account.length());
            return s+"****"+e;
        }else {
            return "";
        }
    ...
    public static String addXing(boolean prox, String account){
        if (account != null) {
//            String s = sub( account, 0, 4 );
            String e = sub( account, account.length() - 5,  account.length());
            return "****"+e;
        }else {
            return "";
        }
