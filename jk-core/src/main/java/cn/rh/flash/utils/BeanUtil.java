...
public class BeanUtil {
     ...
     * 缓存字段名和中文注释对应关系的map
     */
    private static Map<String, String> fieldMap = cn.rh.flash.utils.Maps.newHashMap();
    ...
    * @param os 对象组
     ...
     * @return 转换后的目标类的实例
     */
    public static <T> T objToBean(Object object, Class<T> bean) {
        T t = null;
        try {
            t = new ObjectMapper().convertValue(object, bean);
        } catch (Exception e) {
            logger.error("obj 转 bean 失败!异常"+e.getMessage());
            t = null;
        }
        return t;
    }
